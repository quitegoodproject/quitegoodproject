...
| **NAVRE** | RFC-001 Next-Action & Value Routing Protocol | `npm install @quitegoodproject/navre-sdk` |
| **LandScope** | PostGIS Parcel & Solar Feasibility Engine | `<landscope-widget>` |
